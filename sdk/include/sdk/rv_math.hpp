...
// Ревизия: stage 8 — векторы и матрицы 4x4, левосторонние конвенции.
// ──────────────────────────────────────────────────────────────────────────────
#pragma once
...
// Linear algebra for discs. The console has NO 3D: rv_vertex is a pair of screen
// int16, and everything above that line is the game's job (exactly as the GTE was
// a coprocessor the PSX programmer drove by hand). This header is that job's
// toolbox, and nothing here ever crosses the PDK boundary.
//
// ── CONVENTIONS, fixed once and relied on by the whole sdk/ tree ──────────────
//
...
// basis of screen-space back-face culling (see sdk/rv_xform.hpp).
