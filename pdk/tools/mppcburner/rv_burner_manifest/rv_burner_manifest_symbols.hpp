...
class rv_burner_manifest_symbols
{
public:
	// --- static: the schema ---------------------------------------------------

	const rv_burner_section_spec *lookup_section(std::string_view name) const;
	const rv_burner_key_spec *lookup_key(const rv_burner_section_spec &section,
