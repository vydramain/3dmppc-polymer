...
enum class rv_burner_token_kind : int {
...
struct rv_burner_token {
	rv_burner_token_kind kind = rv_burner_token_kind::END_OF_FILE;
	std::string text;
	int64_t num = 0;
	int line = 0;
};
...
inline std::string rv_burner_token_spelling(const rv_burner_token &t)
{
	switch (t.kind) {
	case rv_burner_token_kind::IDENT:
	case rv_burner_token_kind::INVALID:
		return "'" + t.text + "'";
	case rv_burner_token_kind::EQUALS:
		return "'='";
	case rv_burner_token_kind::LBRACKET:
		return "'['";
	case rv_burner_token_kind::RBRACKET:
		return "']'";
	case rv_burner_token_kind::COMMA:
		return "','";
	case rv_burner_token_kind::STRING:
		return "a string";
	case rv_burner_token_kind::INTEGER:
		return "an integer";
	case rv_burner_token_kind::NEWLINE:
		return "end of line";
	case rv_burner_token_kind::END_OF_FILE:
		return "end of file";
	}
