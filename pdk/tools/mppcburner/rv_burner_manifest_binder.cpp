...
struct bind_rule {
	...
	std::string_view key;
	void (*apply)(rv_manifest &, const rv_burner_mvalue &);
};

constexpr bind_rule RULES[] = {
	{ rv_burner_section_disc, // [disc] id = "…"
		rv_burner_key_disc_id,
		[](rv_manifest &m, const rv_burner_mvalue &v) {
			m.disc_id = v.str;
		} },
...
rv_manifest rv_burner_manifest_bind(const rv_burner_tree &tree)
{
