...
// Ревизия: stage 10 — офлайн-конвертер PNG → .mppctex (IDX4/IDX8/DIRECT15).
// ──────────────────────────────────────────────────────────────────────────────
//
// mppcbaker — the build-time half of the texture pipeline.
//
...
int main(int argc, char** argv) { return rv_pdktools::run(argc, argv); }
