...
const rv_manifest_section_spec *rv_manifest_symbols::lookup_section(
	std::string_view name) const
{
	return rv_manifest_sections_get(name);
}

const rv_manifest_key_spec *rv_manifest_symbols::lookup_key(
	const rv_manifest_section_spec &section, std::string_view name) const
{
	return rv_manifest_keys_get(section, name);
}

bool rv_manifest_symbols::define_section(const std::string &name, int line, int &first_line)
{
	return define(sections_, name, line, first_line);
}

bool rv_manifest_symbols::define_key(const std::string &section, const std::string &key,
