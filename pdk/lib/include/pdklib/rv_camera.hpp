...
// in pdklib/rv_math.hpp — left-handed, +z forward, column vectors, row-major storage.
//
...
//   "is w big enough" and the ordering-table key is just w (see pdklib/rv_xform.hpp).
