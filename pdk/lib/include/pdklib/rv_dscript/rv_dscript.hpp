// RV_MPPC_DISC_LUA_DEF derives a class from RV_MPPC_DISC_CL_CLASS's
...
// RV_MPPC_DISC_CL_CLASS's own frame_render() only reports success rather
// than flushing itself. A disc built straight on RV_MPPC_DISC_CL_CLASS is
...
#define RV_MPPC_DISC_LUA_DEF(title_literal)                     \
    RV_MPPC_DISC_CL_CLASS(rv_dscript_disc_base_, title_literal) \
