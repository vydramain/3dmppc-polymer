...
// Ревизия: stage 10 — рисование текста квадами: атлас, палитра, раскладка строки.
// ──────────────────────────────────────────────────────────────────────────────
#pragma once
...
#include "pdklib/rv_font_data.hpp"
...
// instead of wrapping — the same rule pdklib/rv_xform.hpp applies to projected
