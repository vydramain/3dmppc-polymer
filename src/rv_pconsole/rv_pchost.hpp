...
// Revision: stage 7 — SDL host: presentation, controller snapshots, audio stream.
// ──────────────────────────────────────────────────────────────────────────────
//
...
class rv_pchost {
   public:
    ...
    bool video_ready() const { return video_ready_; }
    // Did SDL's gamepad subsystem come up? Ports read as empty when it did not.
    bool gamepad_ready() const { return gamepad_ready_; }
