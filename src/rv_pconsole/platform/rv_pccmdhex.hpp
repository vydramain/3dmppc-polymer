...
// development runtime speaks it, so rv_pccmdhex_devtools.cpp is compiled only into a
...
// Hex of a DIAGNOSTIC string, cut to RV_PCCMDCHAN_MSG_MAX bytes first with the
...
// the message cut and encoded by rv_pccmd_hex_msg.
