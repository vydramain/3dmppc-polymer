// rv_pccl_luajit reload: the entry and module reload capability, player build twin, plus
// the player answer for the hook-call ceiling. 3DMPPC_DEVTOOLS is OFF here, so
// every reload override refuses without touching Lua, and no ceiling is armed
// around a hook call.
