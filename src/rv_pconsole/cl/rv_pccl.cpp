...
rv_pccl::rv_pccl(const rv_pccl_conf &conf, rv_pccd &cd)
    : conf_(conf)
    , cd_(cd)
    , budget_(conf.script_memory_size)
{
    // Zero is the field nobody wrote: no scripts — rv_pcca's own --no-audio.
    if (budget_ == 0) {
        RV_LOG_INFO("pccl", "scripting off (no [budget.pccl], no-op)");
        return;
    }
...
// Off is TRUE (never asked for); on with no VM is the only FALSE.
bool rv_pccl::valid() const
{
    return budget_ == 0 || L_ != nullptr;
}
...
void *rv_pccl::rv_alloc(void *ud, void *ptr, size_t osize, size_t nsize)
{
    rv_pccl *self = static_cast<rv_pccl *>(ud);
    if (nsize == 0) {
        if (ptr != nullptr) {
...
int64_t rv_pccl::script_load(const void *bytecode, int64_t size, const char *name)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL; // no VM: this disc declared no scripts
    }
...
int64_t rv_pccl::script_free(int64_t handle)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
// --- group B: raw stack access, direct lua_* wrappers guarded by "is a VM up" ---
int64_t rv_pccl::stack_push_nil()
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::stack_push_boolean(bool value)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::stack_push_integer(int64_t value)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::stack_push_number(double value)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::stack_push_string(const char *text, int64_t length)
{
    if (L_ == nullptr || text == nullptr || length < 0) {
        return RV_ERR_INVAL;
    }
    lua_pushlstring(L_, text, static_cast<size_t>(length));
    return RV_OK;
}
int64_t rv_pccl::stack_push_pointer(void *p)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
// L_ == nullptr short-circuits before lua_gettop(L_) ever runs on a null VM.
int64_t rv_pccl::stack_drop(int64_t count)
{
    if (L_ == nullptr || count < 0 || count > lua_gettop(L_)) {
        return RV_ERR_INVAL;
    }
    lua_pop(L_, static_cast<int>(count));
    return RV_OK;
}
int64_t rv_pccl::stack_count()
{
    return L_ == nullptr ? RV_ERR_INVAL : static_cast<int64_t>(lua_gettop(L_));
}
int64_t rv_pccl::value_type(int64_t index)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::value_boolean(int64_t index, bool *out)
{
    if (L_ == nullptr || out == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::value_integer(int64_t index, int64_t *out)
{
    if (L_ == nullptr || out == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::value_number(int64_t index, double *out)
{
    if (L_ == nullptr || out == nullptr) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::value_string(int64_t index, char *baddr, int64_t baddr_size)
{
    if (L_ == nullptr || baddr_size < 0) {
        return RV_ERR_INVAL;
    }
...
int64_t rv_pccl::script_call(int64_t handle, const char *fname, int64_t argc, int64_t retc)
{
    if (L_ == nullptr) {
        return RV_ERR_INVAL;
    }
