...
class rv_pcraster {
   public:
    ...
    static void draw_line(rv_pcfbuf& fbuf, const rv_pdk::rv_line& line, int32_t depth,
                          bool z_enabled);
    static void draw_sprite(rv_pcfbuf& fbuf, const rv_pdk::rv_sprite& sprite,
                            const rv_pctexview& texture, int32_t depth, bool z_enabled);
    static void draw_polygon(rv_pcfbuf& fbuf, const rv_pdk::rv_polygon& polygon,
                             const rv_pctexview& texture, int32_t depth, bool z_enabled);
    ...
    static void draw(rv_pcfbuf& fbuf, const rv_pdk::rv_primitive& primitive,
    ...
    static uint16_t pack_rgb555(rv_pdk::rv_color color);
    static uint16_t pack_rgb555_dithered(rv_pdk::rv_color color, int64_t x, int64_t y);
